...
app.post('/api/pedidos', auth, asyncHandler(async (req, res) => {
    ...
    // Notifica por e-mail em segundo plano (fora do caminho crítico do 201)
    enviaEmailPedidoNovo(pedido).catch((error) => console.error('email pedido novo:', error.message));
